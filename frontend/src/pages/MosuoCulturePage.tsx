...
export default function MosuoCulturePage(): JSX.Element {
	...
	useEffect(() => {
		async function loadData(): Promise<void> {
			setLoading(true);
			try {
				const json = (await fetchKnowledgeBaseCommonPage("mosuo-culture")) as MosuoCultureData;
				setData(json || null);
			} catch {
				setData(null);
			} finally {
